!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r=n(1);r(document).ready(function(){var e=r("#needed-list"),t=(r("li"),r(".add-item")),n=r("#btn"),i=r("#add-item-input"),o=r("#arrow-down");i.blur(),e.on("mouseenter",".item",function(){r(this).find(".right-icon").show(),r(this).find(".left-icon").show()}),e.on("mouseleave",".item",function(){r(this).find(".left-icon").hide(),r(this).find(".right-icon").hide()}),e.on("click",".right-icon",function(){r(this).closest("li").fadeOut(300,function(){r(this).remove()})}),e.on("click",".left-icon",function(){r(this).closest("li").toggleClass("color-change")}),n.click(function(){var t=i.val();if(""==t)alert("Please insert an item.");else{var n="<li class='item'><img class='left-icon' src='images/checkmark2.png' height='20' width='20'><a>"+t+"</a><img class='right-icon' src='images/cut.jpg' height='20' width='20'></li>";e.prepend(n)}}),t.keydown(function(t){if(13==t.which){var n=i.val();if(""==n)alert("Please insert an item.");else{var r="<li class='item'><img class='left-icon' src='images/checkmark2.png' height='20' width='20'><a>"+n+"</a><img class='right-icon' src='images/cut.jpg' height='20' width='20'></li>";e.prepend(r)}return i.blur(),!1}}),o.click(function(){r("#needed-list").slideToggle("slow")}),i.focus(function(){r(this).val("")})})},function(e,t,n){var r,i;/*!
...
//# sourceMappingURL=shoppingList.0.0.0.min.js.map